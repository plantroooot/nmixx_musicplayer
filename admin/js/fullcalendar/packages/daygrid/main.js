...
(function (global, factory) {
    ...
    */
    ...
    function renderCellHtml(date, dateProfile, context, otherAttrs) {
		...
		var date_link = new Date(date);
		var month_link = date.getMonth() + 1; // getMonth()는 0부터 시작하므로 1을 더해줌
		var day_link = date_link.getDate();
		var formattedDate = (month_link < 10 ? '0' : '') + month_link + '-' + (day_link < 10 ? '0' : '') + day_link;
//onclick="view_link(\''+formattedDate+'\')"
