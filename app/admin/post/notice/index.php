                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr <?php echo $topBg; ?>>
                            ...
                            <td <?php echo $targetUrl; ?>>
                                <img src="/admin/img/megaphone.png" width="26" alt="TOP공지">
                            </td>
                            <?php } else { ?>
                            <td <?php echo $targetUrl; ?>><?php echo $rowPageCount[0] - (($post->reqPageNo-1)*$pageRows) - $key?></td>
                            <? } ?>
                            <td <?php echo $targetUrl; ?> class="txt_l">
                                <?php echo $row['post_title']?>                                
                                <? if (checkNewIcon($row['post_datetime'], $row['post_newdate'])) { ?>
