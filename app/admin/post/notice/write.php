            ...
            <section id="anc_bo_basic">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="check_box">                                                
                                        <input type="checkbox" name="post_top" value="Y" id="post_top" <?php echo $data['post_top'] ? 'checked' : ''; ?>>
                                        <label for="post_top">탑공지</label>                                        
                                    </span>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="tbl_frm01 tbl_wrap">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <th scope="row"><label for="post_title">제목(국문)<strong class="sound_only">필수</strong></label></th>
                                <td colspan="3">
                            ...
                            <tr>
                                <th scope="row"><label for="post_title_en">제목(영문)<strong class="sound_only">필수</strong></label></th>
                                <td colspan="3">
                            ...
                            <tr>
                                <th scope="row"><label for="post_contents">내용(국문)<strong class="sound_only">필수</strong></label></th>
                                <td colspan="3">
                                    <textarea name="post_contents" id="post_contents"><?php echo $data['post_contents']; ?></textarea>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label for="post_contents_en">내용(영문)<strong class="sound_only">필수</strong></label></th>
                                <td colspan="3">
